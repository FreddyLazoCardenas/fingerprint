package com.example.freddy_lazo.fingerprinteverisdemo;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void fingerClicked(){
        if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.M && isFingerOk) {
            new PurchaseButtonClickListener(defaultCipher, DEFAULT_KEY_NAME);
        } else {
            Toast.makeText(this, "Dispositivo no soporta huellas", Toast.LENGTH_LONG).show();
        }
    }
